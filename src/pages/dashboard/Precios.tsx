...
export const Precios = () => {
    ...
    return (
        <div className="mx-5">
            <div>
                <h2 className="text-xl font-bold mt-5">Configuracion de Precios</h2>
                <p className="text-gray-500">Define el precio base para 2 personas. Los demas precios se calcular automaticamente</p>
            </div>

            <div className="flex flex-col md:flex-row mt-10 mb-10 w-full justify-between gap-10">

                <div className="flex-1">
                    <h3 className="text-lg font-semibold mb-2">Precio Base (2 Personas)</h3>
                    <form className="flex gap-5" onSubmit={handlePrecio}>
                        ...
                        <button type="submit" className="bg-blue-800 cursor-pointer hover:bg-blue-700 text-white rounded-sm px-2 py-1" disabled={isPendingModificar}>{isPendingModificar ? 'Guardando...' : 'Guardar'}</button>

                    </form>
                    <span className="text-xs text-gray-600">Este es el precio referencia para habitaciones de 2 personas</span>
                </div>


                <div className="font-semibold">
                    <h3 className="text-xl">Tabla de los precios Calculados</h3>
