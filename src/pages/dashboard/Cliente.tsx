    ...
    <main>
      ...
      <div className="text-black mx-5 my-2">
        <input
          ...
          className="placeholder:text-slate-500 w-full p-2 border border-slate-300 bg-white rounded-md focus:outline-none focus:border-sky-500 dark:bg-slate-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700"
        />
      </div>
