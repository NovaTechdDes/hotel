      ...
      <div className="flex flex-col items-center justify-center h-full bg-slate-200">
        <div className="bg-white rounded-lg flex flex-col items-center w-[500px] h-[600px] shadow-md pt-10 text-black px-5">
          <div className="flex flex-col items-center justify-center">
            ...
            <h1 className="text-2xl font-bold text-center">Mis Casitas</h1>
          ...
          <form className="flex flex-col gap-4 w-full  px-10" onSubmit={handleLogin}>
            <div className="flex w-full flex-col gap-1">
              ...
              <div className="relative full">
                <CiMail size={20} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                <input
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  type="email"
                  name="email"
                  className="border w-full px-10 py-2 opacity-80 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              <label className="flex flex-col gap-1">
                ...
                <div className="relative w-full">
                  <TbLockPassword size={20} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                    type="password"
                    name="contrasena"
                    className="border w-full px-10 py-2 opacity-80 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
                    placeholder="**********"
                  />
                </div>
              </label>
            ...
            <Link to="/recuperar-contraseña" className="text-blue-600 hover:underline text-center">
