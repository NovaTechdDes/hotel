            ...
            <div className="bg-white rounded-lg shadow-lg w-4xl h-[80vh] p-8 text-black">
                ...
                <form className="flex flex-col gap-4" onSubmit={handleSubmitForm}>
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1" htmlFor="dni">DNI*</label>
                            <input
                                type="text"
                                id="dni"
                                name="dni"
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1" htmlFor="domicilio">Domicilio</label>
                            <input
                                type="text"
                                id="domicilio"
                                name="domicilio"
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1" htmlFor="localidad">Localidad</label>
                            <input
                                type="text"
                                id="localidad"
                                name="localidad"
                    ...
                    <div className="flex justify-end mt-4 gap-2">
                        <button
                            type="button" className="px-4 py-2 bg-gray-300 rounded hover:bg-green-300 cursor-pointer transition" onClick={handleCloseModal}>Cancelar</button>
                        {!clienteSeleccionado ? (
