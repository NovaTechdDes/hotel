            ...
            <div className="bg-white rounded-lg shadow-lg w-xl h-[30vh] p-8 text-black flex flex-col">
                ...
                <form
                    ...
                    <div>
                        ...
                        <input autoFocus type="text" name="descripcion" value={descripcion} onChange={onInputChange} id="descripcion" className='w-full border rounded-md px-3 py-2' placeholder='Ej: Mantenimiento' />
                    ...
                    <div className="flex justify-end mt-auto gap-2">
                        ...
                        {!tipoEgresoSeleccionado && <button type="submit" disabled={isPendingAgregar} className="px-4 py-2 bg-black text-white rounded hover:opacity-80 cursor-pointer transition" >
                            {isPendingAgregar ? 'Guardando...' : 'Guardar'}
                        </button>}

                        {tipoEgresoSeleccionado && <button type="submit" disabled={isPendingModificar} className="px-4 py-2 bg-black text-white rounded hover:opacity-80 cursor-pointer transition" >
